...
%    ① 硅烷比按历史实际执行定 5:1（MTMS:DMDMS = 25:5，非 1:1），一批 75 g = 62.5+12.5 g
...
%  v2.2（2026-09-13 重排）：执行进度——09-03 晚硅烷原液（1 号烧杯）预水解、09-04 加 DMF 成基液 150 g + 四个烧杯的 PVP 液（外层烧杯 A/A0、A/A0 中层烧杯）已完成；锆与糖水未加，液体密封停置至今（纺前必做检查与小样试纺，增稠/凝胶则重配基液）。SOP 与时间表自 09-14 纺 A 起重排，决策节点 09-18 / 09-20 / 09-22。
% ============================================================
...
\textbf{记录要求}：硅烷比 5:1（MTMS:DMDMS，D3 支线 3:1 例外）、基液（硅烷:DMF）1:1、Zr 0.64\,g/10\,g 基液 $\approx$ 5 mol\% 的口径在实验本写死；\textbf{试剂纯度与摩尔账一并入账}（MTMS 98\%、DMDMS 97\%、d-无水葡萄糖 99\%、PVP K88-96，换算见下）；记录\textbf{实际投入的葡萄糖、去离子水与正丙醇锆质量}，不只记"几克"。

\textbf{试剂规格与摩尔换算（2026-09-03 试剂瓶签口径）}：甲基三甲氧基硅烷 MTMS \textbf{98\%}（MW 136.22）；二甲基二甲氧基硅烷 DMDMS \textbf{97\%}（MW $\approx$120）；d-无水葡萄糖 \textbf{99\%}（MW 180.16，无水可免 105\,°C 烘干，受潮仍烘）；PVP \textbf{K88-96}（$M_{\mathrm{w}}\approx1.3\times10^{6}$）；DMF（MW 73.09）；正丙醇锆按纯品 MW 327.6 折算。

\textbf{每 10\,g 基液的摩尔账}（= 硅烷混液 5.00\,g，5:1 拆为 MTMS 4.167\,g + DMDMS 0.833\,g，加 DMF 5.00\,g；按实际纯度折算，纯度对摩尔比影响 $\le$2\%，SOP 用量不变，仅记录口径）：

\begin{table}[htbp]
\centering
\caption{试剂摩尔换算（每 10\,g 基液，按瓶签纯度）}
\begin{tabularx}{\textwidth}{l r r X}
\toprule
组分 & 投入质量 & 纯品质量 & 摩尔 / 折算 \\
\midrule
MTMS（98\%） & 4.167\,g & 4.083\,g & 29.97 mmol Si \\
DMDMS（97\%） & 0.833\,g & 0.808\,g & 6.72 mmol Si \\
总 Si & -- & -- & $\approx$ 36.7 mmol \\
正丙醇锆 0.64\,g & 0.64\,g & -- & 1.95 mmol Zr $\rightarrow$ Zr:Si $\approx$ 5.3 mol\%（标准，anand 甜点） \\
正丙醇锆 2.56\,g & 2.56\,g & -- & 7.81 mmol Zr $\rightarrow$ $\approx$ 21 mol\%（C-Zr$\uparrow$） \\
葡萄糖 2.00\,g & 2.00\,g & 1.98\,g & 11.0 mmol $\rightarrow$ 糖:Si $\approx$ 30\% \\
葡萄糖 4.00\,g & 4.00\,g & 3.96\,g & 22.0 mmol $\rightarrow$ 糖:Si $\approx$ 60\% \\
\bottomrule
\end{tabularx}
\end{table}

\textbf{糖水浓度}（无水葡萄糖 MW 180.16）：2\,g + 3.0\,mL $\approx$ 3.7 mol/L；4\,g + 4.5\,mL $\approx$ 4.9 mol/L，40--50\,°C 溶清无碍（与历史"3 mol/L 储备液"投 2\,g 的口径一致）。
