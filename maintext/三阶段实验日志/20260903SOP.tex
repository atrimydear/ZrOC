...
\begin{itemize}
  ...
  \item \textbf{进度基线（09-13 实况）}：09-03 晚硅烷罐 1 已预水解完；09-04 已加 DMF 75.0 g 成基液 150 g，并配好四罐 PVP 液（外层罐 A/A0 共用 + A/A0 中层），\textbf{锆与糖水尚未加入}。
  \item \textbf{【必做】停置 9 天的检查}：基液与 PVP 液自 09-04 密封放置至今，硅烷会缓慢缩合、DMF 吸湿，纺前\textbf{逐罐目视}：透明无浑浊、无凝胶块、倾倒无拉丝。\textbf{先取 2--3 mL 小样试纺}判断可纺性；若已增稠/凝胶，\textbf{直接重配基液}（硅烷原液 62.50+12.50 g + 水过夜 → 加 DMF 75.0 g），不要硬纺。
...
第 2 罐硅烷原液 & 同上 62.50 + 12.50 g（09-16 晚配） & 供 C/E/Zr 系列；预水解过夜 \\
...
日期 & 执行内容（用量见 §1/§2） \\
\midrule
09-14（一） & \textbf{进度起点}：\textbf{先做停置检查/小样试纺}（见 §0）。给 A、A0 中层\textbf{补滴正丙醇锆 0.64 g}（各一），搅 30--60 min。07:45 现配 A 糖水（2.00 g + 3.0 mL，40--50\,°C 溶清、冷至 $<$40\,°C）$\rightarrow$ 加入 A 中层搅 15--30 min $\rightarrow$ \textbf{08:30 纺 A}：外(10 mL) $\rightarrow$ 中(10 mL) $\rightarrow$ 外(10 mL)，1.5 mL/h，全金属针头，每层先试纺 1--3 mL 弃，\textbf{连续不中断}，硅油纸 30 cm 条收集，记湿度；称\textbf{初重}，平放晾 1--2 h。下午同法纺 \textbf{A0}（无糖中层直接可用）。傍晚配 B/B0 中层（各 10.00 g 基液 + 1.72 g PVP；B0 无糖无水）搅 6 h，21:00 各加 Zr 0.64 g。纺前各罐取 $\sim$1 mL 测电导率 \\
09-15（二） & 上午配外层罐（B/B0 共用，基液 40.00 g + PVP 6.88 g）搅 6 h。\textbf{A/A0 装炉}（理学楼 227，Ar，两舟编号）：20\,°C $\rightarrow$ 200\,min 到 200\,°C 保温 1 h $\rightarrow$ 400\,min 到 900\,°C 保温 1 h $\rightarrow$ 自然炉冷（过夜） \\
09-16（三） & 上午：出炉 A/A0，称终重/算失重，送 SEM（杜老师）。下午：B 糖水现配（2.00 g + 3.0 mL）加入 B 中层 $\rightarrow$ \textbf{纺 B、B0} $\rightarrow$ \textbf{空气预氧化}（见 §5）$\rightarrow$ 装袋。\textbf{晚}：配第 2 罐硅烷（62.50 + 12.50 + 水）预水解过夜 \\
09-17（四） & 早：第 2 罐硅烷 + DMF 75.0 g 搅 30 min $\rightarrow$ 基液（供 C/E/Zr 系列）密封。\textbf{B/B0 装炉} Ar 900\,°C（同 09-15 程序）。配外层罐（C/E 共用，新基液 40 + 6.88 g PVP）与 C、E 中层（各 10 g 基液 + 1.72 g PVP），搅 6 h，15:30 各加 Zr 0.64 g \\
\bottomrule
\end{tabular}
...
09-19（六） & \textbf{C/E 装炉} Ar 900\,°C（一炉两舟，舟位编号）。配外层罐（Zr 系列共用 40 + 6.88）与 C-Zr$\downarrow$（10 + 1.72 + Zr 0.64）、C-Zr$\uparrow$（10 + 1.72 + \textbf{Zr 2.56 g}）中层，搅 6 h。\textbf{晚}：配 D3 硅烷小批（11.25 + 3.75 g + 水 $\sim$0.2 mL）预水解过夜 \\
